...
#define enteros(e,n) (((e)*(n))/W+(((e)*(n))%W > 0))  //added a parethesis for a correct replacement, by diegocaro
/* bits needed to represent a number between 0 and n */uint bits(uint n);
